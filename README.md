...
## Progress Timeline
| Month 1 | C# Fundamentals & Console Applications | ✅ In Progress |
| Month 2 | ASP.NET Core Web APIs & Databases | 🔜 Next |
| Month 3 | Full-Stack Application Development | 🔜 Future |
...
- Work on some fun personal projects, like a game or a calorie calculator

## Learning Resources
- Microsoft Learn C# Paths
- Exercism C# Track
- .NET Documentation
- Code reviews and a lot of Googling

## Contributing
While these are learning projects, feedback and suggestions are welcome! 
Please open an issue for any code review suggestions or improvements.

## Contact
Niraj Sookdeo - sookdeo.n@outlook.com
